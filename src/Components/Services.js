    ...
    <section id="services" className={styles.Services}>
      ...
      <div className={styles.ServicesGroup}>
        ...
        >
          ...
          <div className={styles.ServiceDescriptionBx}>
            <h4 className={styles.ServiceTitle}>Web Development</h4>
            <span className="decLine"></span>
            <p className={styles.ServiceDescription}>
              Creating interactive and dynamic websites using front-end
        ...
        >
          ...
          <div className={styles.ServiceDescriptionBx}>
            <h4 className={styles.ServiceTitle}>Responsive Web Design</h4>
            <span className="decLine"></span>
            <p className={styles.ServiceDescription}>
              Building websites that are optimized for different devices and
              screen sizes, ensuring a consistent user experience across
        ...
        >
          ...
          <div className={styles.ServiceDescriptionBx}>
            <h4 className={styles.ServiceTitle}>Front-End Frameworks</h4>
            <span className="decLine"></span>
            <p className={styles.ServiceDescription}>
              Utilizing popular front-end framework React Js and Next Js to
              build dynamic and interactive user interfaces with efficient
